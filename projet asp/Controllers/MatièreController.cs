...
namespace projet_asp.Controllers
{
    public class MatièreController : Controller
    {
        ...
        {
            Resources.ModelsResources.Account.ResourceAccount.Culture = Resources.ModelsResources.Etudiant.ResourceEtudiant.Culture = Resources.MyResource.Culture = Resources.ModelsResources.Matière.ResourceMatière.Culture = new System.Globalization.CultureInfo("fr-FR");
            return RedirectToAction("Create");
        }

        public ActionResult CultureEn()
        {
            Resources.ModelsResources.Account.ResourceAccount.Culture = Resources.ModelsResources.Etudiant.ResourceEtudiant.Culture = Resources.MyResource.Culture = Resources.ModelsResources.Matière.ResourceMatière.Culture = new System.Globalization.CultureInfo("en-US");
            return RedirectToAction("Create");
        }
        public ActionResult CultureAr()
        {
            Resources.ModelsResources.Account.ResourceAccount.Culture = Resources.ModelsResources.Etudiant.ResourceEtudiant.Culture = Resources.MyResource.Culture = Resources.ModelsResources.Matière.ResourceMatière.Culture = new System.Globalization.CultureInfo("ar-MA");
            return RedirectToAction("Create");
        }
    }
}
